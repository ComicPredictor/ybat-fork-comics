...
(() => {
    ...
    const listenTextLoad = () => {
        const classesElement = document.getElementById("texts")
            ...
            if (files.length > 0) {
                ...
                if (nameParts[nameParts.length - 1] === "txt") {
                    ...
                    reader.addEventListener("load", () => {
                        ...
                        if (rows.length > 0) {
                            const classList = document.getElementById("textsList")
                            ...
                            if (Object.keys(images).length > 0) {
                                document.getElementById("bboxes").disabled = false  // need change
                                document.getElementById("restoreBboxes").disabled = false  // need change
                            }
                        }
                    })
    ...
    const setCurrentText = () => {
        ...
        currentText = classList.options[classList.selectedIndex].text
    ...
    const listenTextSelect = () => {
        const classList = document.getElementById("textsList")

        classList.addEventListener("change", () => {
            textListIndex = classList.selectedIndex
